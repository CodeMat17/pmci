...
const UpdatePayLateness = ({user_id, paid}) => {
                    ...
                    <div className='mt-6 w-full space-y-2'>
                      <div className='flex flex-col justify-center items-center space-y-4'>
                        ...
                        <Switch
                          ...
                          onChange={setHasPaid}
                          className={`${
                            has_paid ? "bg-green-500" : "bg-gray-400"
                          }
...
export default UpdatePayLateness;
